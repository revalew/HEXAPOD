...
while 1:
    ...
    DXL_MINIMUM_POSITION_VALUE = int(input("Podaj pozycje docelowa: "))
    # print(type(DXL_MINIMUM_POSITION_VALUE))  # Dynamixel will rotate between this value
    DXL_MAXIMUM_POSITION_VALUE = 700
