...
class MotorController(Node):
    def __init__(self, id):
        ...
        self.group_1_sub_ = self.create_subscription(LegGroup, "leg_group_1", self.pose_callback_id, 20)
        self.group_2_sub_ = self.create_subscription(LegGroup, "leg_group_2", self.pose_callback_id_2, 20)
            
        if self.id_id == 1 or self.id_id == 2:
                self.coxa = 0
                self.femur = 1
                self.tibia = 2
        elif self.id_id == 3 or self.id_id == 4:
                self.coxa = 3
                self.femur = 4
                self.tibia = 5
        elif self.id_id == 5 or self.id_id == 6:
                self.coxa = 6
                self.femur = 7
                self.tibia = 8
    ...
    def pose_callback_id_2(self, msg: LegGroup):
