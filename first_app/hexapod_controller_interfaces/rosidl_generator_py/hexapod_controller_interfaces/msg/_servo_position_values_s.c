...
bool hexapod_controller_interfaces__msg__servo_position_values__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("hexapod_controller_interfaces.msg._servo_position_values.ServoPositionValues", full_classname_dest, 76) == 0);
  }
  hexapod_controller_interfaces__msg__ServoPositionValues * ros_message = _ros_message;
  {  // id_pose
    PyObject * field = PyObject_GetAttrString(_pymsg, "id_pose");
    if (!field) {
      return false;
    }
    {
      ...
      Py_ssize_t size = 18;
      int16_t * dest = ros_message->id_pose;
...
{
  /* NOTE(esteve): Call constructor of ServoPositionValues */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("hexapod_controller_interfaces.msg._servo_position_values");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ServoPositionValues");
  ...
  {  // id_pose
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "id_pose");
    if (!field) {
      return NULL;
    }
    assert(field->ob_type != NULL);
    ...
    int16_t * src = &(ros_message->id_pose[0]);
